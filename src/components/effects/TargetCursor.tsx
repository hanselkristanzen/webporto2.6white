...
export function TargetCursor({
  ...
  useEffect(() => {
    ...
    // gsap.quickTo() builds its interpolator once and returns a cheap
    // setter, instead of gsap.to() building a brand-new tween on every
    // single call — this matters here because moveHandler below runs on
    // every mousemove event (potentially 100+ times/sec on a high-poll-rate
    // mouse). MagneticButton elsewhere in this codebase already uses this
    // same pattern for exactly the same reason.
